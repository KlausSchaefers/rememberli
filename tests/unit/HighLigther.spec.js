...
describe('Highlighter.js', () => {
    it('test hightlight (regex)', () => {
      ...
      expect(html.indexOf('<span data-rmli-type="taskOpen" data-rmli-offset="156" data-rmli-length="2"  class="rmi-highlight-task rmi-highlight-task-open"></span>')).toBeGreaterThan(-1)
      expect(html.indexOf('<span data-rmli-type="taskDone" data-rmli-offset="307" data-rmli-length="3"  class="rmi-highlight-task rmi-highlight-task-done"></span>')).toBeGreaterThan(-1)
